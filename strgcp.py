...
# File uploader
uploaded_file = pd.read_excel(st.file_uploader("Upload Excel File", type=["xlsx", "xls"]))

# Process the uploaded file
if uploaded_file is not None:
    process_auction_customer(uploaded_file)
    process_auction_order(uploaded_file)
    process_auction_delivery(uploaded_file)
else:
