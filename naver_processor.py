...
def process_naver_customer(df, sh, spread):
    ...
    try:
        ...
        # Remove duplicates based on 구매자연락처 (phone number)
...
def process_naver_order(df, sh, spread):
    ...
    try:
        ...
        # Join with option_df to get 옵션 key
        ...
        # After merging with option_df
        st.write("Option Merged DataFrame:", option_merged)

        # Join with customer_df to get 고객 key
        ...
        # After merging with customer_df
        ...
        order_data = order_data[order_data['주문 key'].notna() & (order_data['주문 key'] != '')]
